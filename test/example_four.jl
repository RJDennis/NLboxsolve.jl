...
function test_nlboxsolve_outplace()
    ...
    soln_lm_fan_sparse = constrained_levenberg_marquardt_fan_sparse(test6,x0,l,u,ftol=1e-15,xtol=1e-15)
    ...
    soln_nk_fs_sparse  = constrained_newton_krylov_fs_sparse(test6,x0,l,u,ftol=1e-15,xtol=1e-15)
