...
function test_nlboxsolve_outplace()
    ...
    soln_trust  = constrained_trust_region(test8,x0,l,u,xtol=1e-15,ftol=1e-15)
    ...
    soln_trust_sparse  = constrained_trust_region_sparse(test8,x0,l,u,ftol=1e-15,xtol=1e-15)
